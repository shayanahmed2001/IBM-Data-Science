...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(figure=px.box(average_sales,
                            x='Vehicle_Type',
                            y='Automobile_Sales',
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        eou_rec= recession_data.groupby(['unemployment_rate','Vehicle_Type'])['Automobile_Sales'].mean().reset_index()
        R_chart4 = dcc.Graph(
                    figure=px.bar(eou_rec,
                                x='unemployment_rate',
                                y='Automobile_Sales',
                                color='Vehicle_Type',
